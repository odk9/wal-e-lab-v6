...
LOG_FILE="$PROJECT_DIR/run_wave9.log"
...
echo "=============================================" | tee "$LOG_FILE"
echo "  WAL-E LAB V6 — WAVE 9 (8 scripts)"        | tee -a "$LOG_FILE"
