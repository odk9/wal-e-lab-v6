#!/bin/bash
# =============================================================================
# run_wave1.sh — Vague 1 : repos légers (audio/matching/CV/recommandation)
#
# Scripts : gonic, songrec, duolicious, snapchat_filters, implicit
# + Session 4 : bark, podcastfy, radicale, open_notebook, ace_step, rtvc
# Total : 11 scripts, ~127 patterns
#
# Usage :
#   cd "/Users/onlydkira/Documents/Genesis One/Wal-e Lab 08-02-2026/Wal-e Lab V6"
#   chmod +x run_wave1.sh
#   ./run_wave1.sh
# =============================================================================
...
LOG_FILE="$PROJECT_DIR/run_wave1.log"
...
echo "=============================================" | tee "$LOG_FILE"
echo "  WAL-E LAB V6 — VAGUE 1 (11 scripts)"       | tee -a "$LOG_FILE"
echo "  Started: $(date)"                            | tee -a "$LOG_FILE"
echo "=============================================" | tee -a "$LOG_FILE"

# ── Session 4 (déjà prêts) + Vague 1 (nouveaux) ─────────────────────────────
SCRIPTS=(
    "ingest_bark.py"
    "ingest_podcastfy.py"
    "ingest_radicale.py"
    ...
    "ingest_gonic.py"
    "ingest_songrec.py"
    "ingest_duolicious.py"
    "ingest_snapchat_filters.py"
    "ingest_implicit.py"
)
