#!/bin/bash
# =============================================================================
# run_wave3.sh — Vague 3 : repos lourds (ComfyUI/Plane/Navidrome/Twitter)
#
# Scripts : comfyui, plane, navidrome, twitter_algo
# Total : 4 scripts, ~48 patterns
#
# Usage :
#   cd "/Users/onlydkira/Documents/Genesis One/Wal-e Lab 08-02-2026/Wal-e Lab V6"
#   chmod +x run_wave3.sh
#   ./run_wave3.sh
# =============================================================================
...
LOG_FILE="$PROJECT_DIR/run_wave3.log"
...
echo "=============================================" | tee "$LOG_FILE"
echo "  WAL-E LAB V6 — VAGUE 3 (Repos lourds)"     | tee -a "$LOG_FILE"
